...
class GameRemoteDataSourceImpl implements GameRemoteDataSource {
  ...
  Map<String, dynamic> _gameToSupabaseJson(Game game) {
    return {
      ...
      'original_game_to_points': game.originalGameToPoints,
      'hard_cap_points': game.hardCapPoints,
      'halftime_at_override': game.halftimeAtOverride,
  ...
  Game _gameFromSupabaseJson(Map<String, dynamic> json) {
    return Game(
      ...
      halftimeHomeScore: json['halftime_home_score'] as int?,
      halftimeAwayScore: json['halftime_away_score'] as int?,
      gameToPoints: json['game_to_points'] as int? ?? 15,
      originalGameToPoints: json['original_game_to_points'] as int?,
      hardCapPoints: json['hard_cap_points'] as int? ?? 17,
      halftimeAtOverride: json['halftime_at_override'] as int?,
      ...
      gameNotes: json['game_notes'] as String?,
